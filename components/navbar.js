  ...
  return (
      <div className='container-fluid p-0 col-lg-10 col-xxl-8 pt-lg-5 rounded sticky-top'>
        <Navbar
          ...
          <div className='container-fluid p-0'><Navbar.Brand href='/' className='text-dark'><img
            src='/navbar-graphic.svg'
            className='d-inline-block img-fluid rounded' height='64px' width='240px' alt=''/></Navbar.Brand>
