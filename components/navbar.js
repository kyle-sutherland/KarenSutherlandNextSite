...
const navigation = [
    ...
    {name: 'Fees', href: '/fees', current: null},
                    ...
                    <div className="justify-between pr-4 lg:pr-0 mx-auto lg:max-w-7xl md:items-center md:flex md:pr-8">
                        <div>
                            <div className="flex items-center justify-between md:block">
                                <a href="/">
                                    <img src='/kslogo-navbar-graphic1.svg' width={'240px'} height={'64px'} alt=''/>
                                </a>
                        ...
                        <div className='flex flex-1 items-center justify-center sm:items-stretch sm:justify-end'>
                            <div className='hidden sm:ml-6 sm:block'>
                                <div
                                    className="items-center justify-center px-4 space-y-8 md:flex md:space-x-3 md:space-y-0">
                                    {navigation.map((item) => (
                                        <a key={item.name}
                                           href={item.href}
                                           className={classNames(
                                               item.current ? 'text-gray-900 bg-gray-300' : 'text-charcoal bg-inherit hover:bg-gray-200 hover:text-gray-900',
